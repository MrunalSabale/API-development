...
public class CategoryController {
	...
	public ResponseEntity<Page<Category>> catpaging(@PathVariable Integer pageNumber,@PathVariable Integer pageSize){
		
		 Page<Category> page= categoryService.getCatpaging(pageNumber ,pageSize );
